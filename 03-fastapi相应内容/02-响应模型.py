...
@app.get("/cases", status_code=200, response_model=list[CaseModel])
def get_all_cases():
    """
    获取所有案例信息
    :return:
...
@app.post("/cases", status_code=201, response_model=CaseModel)
...
@app.put("/cases/{case_id}/", status_code=200, response_model=CaseModel)
